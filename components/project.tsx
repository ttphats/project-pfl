...
export default function Project({
  ...
  return (
    ...
    overflow-hidden sm:pr-8 relative sm:h-[20rem] group-even:pl-8
    hover:bg-gray-200 transition dark:text-white dark:bg-white/10  dark:hover:bg-white/20"
      ...
      gap-2 sm:mt-auto"
        ...
        <Image
          ...
          quality={95}
          className="absolute top-8 -right-[24rem] w-
        [28.25rem] rounded-t-lg shadow-2xl
        transition
